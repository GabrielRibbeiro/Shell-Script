...
# HTML_PARSING.sh - Este script em Bash foi desenvolvido para analisar o conteúdo HTML de uma página  web e 
# identificar subdomínios embutidos no código.
# Ele é especialmente útil para profissionais de segurança cibernética que desejam realizar tarefas de reconhecimento
# e mapeamento de subdomínios durante um teste de penetração ou uma auditoria de segurança.
#
# --------------------------------------------------------------------------------------------------------------------
# Autor: Gabriel Ribeiro <gabriel.mmatos@proton.me>
# Manutenção: Gabriel Ribeiro <gabriel.mmatos@proton.me>
# --------------------------------------------------------------------------------------------------------------------
